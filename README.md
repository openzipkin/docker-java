...
```bash
$ docker run --rm ghcr.io/openzipkin/java:8.472.08 -version
openjdk version "1.8.0_472"
OpenJDK Runtime Environment (IcedTea 3.37.0) (Alpine 8.472.08-r1)
...
```bash
# Note 8.472.08 not 8.472.08-r1!
./build-bin/build 8.472.08
```
...
To release the image, push a tag matching the arg to `build-bin/build` (ex `8.472.08`).
